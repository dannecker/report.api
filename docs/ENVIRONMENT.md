...
| ------------- | ----------------------- | ----------- |
| ERLANG_COOKIE | `2/xF2/JsTH7rezSHEKB01vdNqYLvdXXjIT+Rosl4maInstNlBdEhZqYSuERHwYSs` | Erlang [distribution cookie](http://erlang.org/doc/reference_manual/distributed.html). **Make sure that default value is changed in production.** |
...
| VAR_NAME      | Default Value | Description |
| ------------- | ------------- | ----------- |
| DB_NAME       | `report_dev` | Database name. |
...
| VAR_NAME      | Default Value | Description |
| ------------- | ------------- | ----------- |
| DATABASE_URL  | not set       | Database URI. Example: `postgres://postgres:postgres@travis:5432/report_dev` |
...
| SECRET_KEY    | `U6jv7YneKVixSMz0h4Z/W1P5gifuhS0rekLu2tuZRsZmE856L71BcjX18tNzZmVu` | Phoenix [`:secret_key_base`](https://hexdocs.pm/phoenix/Phoenix.Endpoint.html). **Make sure that default value is changed in production.** |
